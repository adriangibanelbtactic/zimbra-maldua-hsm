...
public class ZetaHsmMoveBlobsUtil {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Blobs Moved: %d%n", resp.getNumBlobsMoved());
            System.out.printf("Bytes Moved: %d%n", resp.getNumBytesMoved());
            System.out.printf("Total Mailboxes: %d%n", resp.getTotalMailboxes());
